...
const Right = () => {
  return (
    <div className='w-[100%] md:w-[100%] lg:w-[50%]'>
        ...
        <Link to='/experiences'>
            <div className='flex flex-col after:rounded-lg after:duration-300 after:w-1 after:inline-flex after:h-[1px] after:bg-white hover:after:w-full cursor-pointer duration-300 hover:scale-105 appearOne mx-auto w-[60%] md:h-[36%] h-[30%] my-8 rounded-lg bg-zinc-900'>
